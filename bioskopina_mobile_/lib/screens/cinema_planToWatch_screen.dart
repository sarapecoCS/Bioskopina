...
class CinemaPlanToWatchScreen extends StatefulWidget {
  final int selectedIndex;
  const CinemaPlanToWatchScreen({super.key, required this.selectedIndex});

  @override
  State<CinemaPlanToWatchScreen> createState() => _CinemaPlanToWatchScreenState();
}

class _CinemaPlanToWatchScreenState extends State<CinemaPlanToWatchScreen> {
