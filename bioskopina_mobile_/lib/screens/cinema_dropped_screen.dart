...
class CinemaDroppedScreen extends StatefulWidget {
  final int selectedIndex;
  const CinemaDroppedScreen({super.key, required this.selectedIndex});

  @override
  State<CinemaDroppedScreen> createState() => _CinemaDroppedScreenState();
}

class _CinemaDroppedScreenState extends State<CinemaDroppedScreen> {
    ...
    return FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return const Empty(
              text: Text("No dropped movies found"),
