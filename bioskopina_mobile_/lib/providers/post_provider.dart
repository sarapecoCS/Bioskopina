...
class PostProvider extends BaseProvider<Post> {
  ...
  List<Post> _posts = []; // Missing list to hold fetched posts!
  ...
  List<Post> get posts => _posts; // Getter used by PostScreen

  // Fetches posts and stores them
 ...
 void updatePostLocally(Post updatedPost) {
  ...
  Future<void> toggleLike(Post post) async {
    ...
    try {
      ...
      notifyListeners(); // Important: notify screen about the change
    } catch (e) {
