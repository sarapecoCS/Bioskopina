...
class Palette {
  ...
  static const LinearGradient menuGradient = LinearGradient(colors: [
    ...
    Color.fromRGBO(82, 31, 53, 1), // Deep red with a hint of vintage purple
  ]);
  static const LinearGradient buttonGradient = LinearGradient(colors: [
    Color.fromRGBO(138, 38, 58, 1),  // Burgundy red
    Color.fromRGBO(73, 18, 34, 1),   // Muted dark maroon
  ]);
  ...
  static const LinearGradient barChartGradient2 = LinearGradient(
    colors: [
      Color.fromRGBO(34, 34, 51, 1),   // Dark muted blue-black
      Color.fromRGBO(101, 53, 82, 1),  // Deep reddish-purple
      Color.fromRGBO(179, 148, 77, 1), // Earthy gold/olive tone
    ],
    begin: Alignment.bottomCenter,
    end: Alignment.topCenter,
  );
  ...
  static const LinearGradient barChartGradient3 = LinearGradient(
    colors: [
      Color.fromRGBO(120, 49, 74, 1),  // Earthy reddish-brown
      Color.fromRGBO(67, 32, 49, 1),   // Deep maroon
      Color.fromRGBO(113, 47, 68, 1),  // Rich burgundy red
    ],
    begin: Alignment.bottomCenter,
    end: Alignment.topCenter,
  );
  ...
  static const LinearGradient barChartGradient4 = LinearGradient(
    colors: [
      Color.fromRGBO(189, 108, 53, 1),  // Warm vintage gold
      Color.fromRGBO(112, 54, 98, 1),   // Deep purple-red
    ],
    begin: Alignment.bottomCenter,
    end: Alignment.topCenter,
  );
  ...
  static const LinearGradient navGradient1 = LinearGradient(
    colors: [
      Color.fromRGBO(138, 38, 58, 0.8),   // Burgundy red (from buttonGradient)
      Color.fromRGBO(73, 18, 34, 0.8),    // Muted dark maroon
    ],
  );

  static const LinearGradient navGradient2 = LinearGradient(
    colors: [
      Color.fromRGBO(101, 53, 82, 0.8),   // Deep reddish-purple
      Color.fromRGBO(179, 148, 77, 0.8),  // Earthy gold/olive tone
  ...
  static const LinearGradient navGradient3 = LinearGradient(
    colors: [
      Color.fromRGBO(120, 49, 74, 0.8),   // Earthy reddish-brown
      Color.fromRGBO(113, 47, 68, 0.8),   // Rich burgundy red
      Color.fromRGBO(67, 32, 49, 0.8),    // Deep maroon
    ],
  );

  static const LinearGradient navGradient4 = LinearGradient(
    colors: [
      Color.fromRGBO(112, 54, 98, 0.85),  // Deep purple-red
      Color.fromRGBO(189, 108, 53, 0.85), // Warm vintage gold
    ],
  );

  static const LinearGradient navGradient5 = LinearGradient(
    colors: [
      Color.fromRGBO(138, 38, 58, 0.8),   // Burgundy red
      Color.fromRGBO(179, 148, 77, 0.8),  // Earthy gold/olive tone
      Color.fromRGBO(101, 53, 82, 0.8),   // Deep reddish-purple
    ],
  );
